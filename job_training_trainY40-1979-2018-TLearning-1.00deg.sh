...
#SBATCH -o training.trainY40-1979-2018-TLearning-1.00deg.%j.out
#SBATCH -e training.trainY40-1979-2018-TLearning-1.00deg.%j.out
#SBATCH --nodes=4
...
srun --jobid $SLURM_JOB_ID /global/u1/b/bhuang95/sorc/fromTim/anemoi/V20250603/anemoi-house//slurm2ddp.sh anemoi-training train --config-name=config_trainY40-1979-2018-TLearning-1.00deg
